...
- (void)viewDidLoad {
    ...
    [goUrl setTitle:@"访问日记" forState:UIControlStateNormal];
    ...
    goUrl.backgroundColor = [UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.3];
