...
- (void)setupPageControl
{
    ...
    // 2.设置圆点的颜色
      pageControl.currentPageIndicatorTintColor =[UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.3];
...
- (void)setupLastImageView:(UIImageView *)imageView
{
    ...
    [startButton setBackgroundColor:[UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.3]];
    ...
    // 3.设置文字
    [startButton setTitle:@"开始日记" forState:UIControlStateNormal];
