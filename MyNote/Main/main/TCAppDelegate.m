...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window.backgroundColor = [UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.5];//TCCoror(51, 149, 253);//[UIColor whiteColor];
    self.window.tintColor =  [UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.5];
...
- (void)setupUI {
    ...
    appearance.barTintColor = [UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.5];
    ...
    if (@available(iOS 13.0, *)) {
        ...
        navBarAppearance.backgroundColor =  [UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.5];
