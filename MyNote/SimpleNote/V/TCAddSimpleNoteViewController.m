...
-(void)addButten
{
    ...
    tagTitle.text = @"增加一行";
    tagTitle.textColor = [UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.3];
...
-(void)cleateTable
{
    for (int i = 0; i<5; i++)
    {
        NSString * str = [NSString stringWithFormat:@"日程%d",i];
    ...
    sTable.separatorColor = [UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.3];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.selectedBackgroundView.backgroundColor =[UIColor colorWithRed:1.0 green:182/255.0 blue:193/255.0 alpha:0.3];
